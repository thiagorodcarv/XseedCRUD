...
public class ProdutosDestaquesAdapter extends RecyclerView.Adapter {
    ...
    public ProdutosDestaquesAdapter(Context context, List<Produtos> produtos, ClickOnItems clickOnItems,ListDataModel pViewModel) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.produtos_destaques_adapter,parent,false);
        ProdutosDestaqueViewHolder holder = new ProdutosDestaqueViewHolder(view, clickOnItems);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        ProdutosDestaqueViewHolder holder = (ProdutosDestaqueViewHolder) viewHolder;
